...
export function SalesListAdmin({salesData}:SalesListProps) {
  const navigate = useNavigate()
  const tableHeadClasses = "text-amber-50 font-medium";
  return (
    <div className="mx-auto max-w-4xl p-4">
      
      <div className="rounded-lg border bg-background p-6 shadow-sm">
      <h2 className="mb-3 font-bold">All Sales</h2>
        <div className="w-full border rounded-sm relative overflow-hidden">
          ...
          <TableHeader>
           <TableRow className="font-bold bg-[#171717] text-amber-50 group hover:bg-[#171717] hover:text-amber-50">
            <TableHead className={tableHeadClasses}>Producto</TableHead>
            <TableHead className={tableHeadClasses}>Cupo Solicitado</TableHead>
            <TableHead className={tableHeadClasses}>Fecha de Creación</TableHead>
            <TableHead className={tableHeadClasses}>Usuario</TableHead>
          </TableRow>
          </TableHeader>
          <TableBody>
            {salesData.map((sale) => (
